""" Deploy Puppers
Run Puppers on a  single EC2 instance
"""
from aws_cdk import Stack, aws_ec2 as ec2, aws_ecs as ecs, aws_iam as iam
from constructs import Construct


class PuppersStack(Stack):
    """Stack deploys puppers application
    ...
    def __init__(
        ...
        with open("./resource/userdata/puppers.sh", encoding="utf-8") as file:
            user_data = file.read()
